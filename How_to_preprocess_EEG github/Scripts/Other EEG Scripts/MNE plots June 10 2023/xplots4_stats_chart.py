...
rowdatas_all = ['similarity']
rowtitles_all = ['Δ Similarity-to-Others']
...
for fbs in fbandslist:
    ...
    for rds in rowdataslist:
        ...
        #fig, axs = plt.subplots(rows, columns,figsize=(4*columns,1.125*rows),dpi=200)
        ...
        for rn in range(len(rowdatas)):
            ...
            axs[rn,0].text(-0.15,0.5,rowtitles[rn],horizontalalignment='center', verticalalignment='center',transform=axs[rn,0].transAxes,fontsize=6,rotation=90)
