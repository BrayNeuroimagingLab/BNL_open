...
dir_start = '/Users/shefalirai/Desktop/msc_glass_run2/'

participants = [3,4]


#do you want to run on ses-0, ses-12, or both? If both, type ["ses-0","ses-12"]
imagesession = ["ses-func02"]
...
"""****************"""
#spatial mask
fismask = "task-glasslexical_run-02_boldStcFugRefBet_mask.nii.gz"
fismask = "task-glasslexical_run-02_boldStcFugRefConsbet_mask.nii.gz"
...
rdimagename = "task-glasslexical_run-02_boldStcFugMcf.nii.gz"
#spatial mask file. From the main folder
rdmaskname = "task-glasslexical_run-02_boldStcFugRefConsbet_mask.nii.gz"
...
#spatial mask file
filtermaskname = "task-glasslexical_run-02_boldStcFugRefConsbet_mask.nii.gz"
#output file of just the residuals. Saved to regression subfolder
...
gsmask = "task-glasslexical_run-02_boldStcFugRefBet_mask.nii.gz"
...
filterhmpinput = 'task-glasslexical_run-02_boldMcf.nii.gz.par'

#output file of just the residuals. Saved to regression subfolder
filterhmpoutput = 'task-glasslexical_run-02_boldMcf.nii.gz.par_flt.csv'
...
"""***************"""
#text file with 6 head alignment estimates
regheadmotionname = 'task-glasslexical_run-02_boldMcf.nii.gz.par_flt.csv'
...
#mask file
regmaskname = "task-glasslexical_run-02_boldStcFugRefConsbet_mask.nii.gz"
...
warpmatrixfunc2 = 'task-glasslexical_run-02_boldStcFugRefBetFltBbrConcat_mat.h5'#EPI to T1mean ---> this DOESNT work :(
...
#applybetmask = 'task-glasslexical_run-02_run-02ing_boldStcRefBetBbr_mask'
...
inputimageref = 'task-glasslexical_run-02_boldStcFugRefBet'
inputimage = 'StcFugMcfDetFltRegRem'
#warpedimage = "StcMcfDetFltRegRemArbbr"
#warpedimagebet = "StcMcfDetFltRegRemArbbrBet"


warpedimageflt = "StcFugMcfDetFltRegRemArflt" #PROBLEM FILE
    ...
    if (k == 'warp2mni') & (endit == False):
        ...
        for i in participants:
            ...
            for j in imagesession:
                ...
                #functransform2 = dir_start + person + "/ses-func01" + "/func/" + person + "_" + "ses-func01" + "_" + warpmatrixfunc2
