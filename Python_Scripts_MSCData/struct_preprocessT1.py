...
Updated the name of the code: struct_preprocessT1
...
"""**************************************"""
n4input = "T1w"
n4output = "T1wFltmeanAbfc"


"""**********************************"""
"""abe: ANTs Brain Extraction OPTIONS"""
"""**********************************"""
abeinput = "T1wFltmeanAbfc"
abeoutput = "T1wFltmeanAbfcBe"
...
atropinput = "T1wFltmeanAbfcBeAr"
atropCSFoutput = "T1wFltmeanAbfcBeArCSF"
atropGMoutput = "T1wFltmeanAbfcBeArGM"
atropWMoutput = "T1wFltmeanAbfcBeArWM"
...
"""*******************************************"""
segwarpinput1 = "T1wFltmeanAbfcBeArCSF"
segwarpoutput1 = "T1wFltmeanAbfcBeCSF"

segwarpinput2 = "T1wFltmeanAbfcBeArGM"
segwarpoutput2 = "T1wFltmeanAbfcBeGM"

segwarpinput3 = "T1wFltmeanAbfcBeArWM"
segwarpoutput3 = "T1wFltmeanAbfcBeWM"

#what matrix file warps the inputs to the outputs?
segwarpmatrix = "transformT1wFltmeantoMNIinverse.h5" 

#give a reference image for the output files. Presumably the native space image
segwarpreference = "T1wFltmeanAbfcBe"


"""*************************"""
"""wmmask: fslmaths OPTIONS"""
"""*************************"""
wmmaskinput = "T1wFltmeanAbfcBeWM"
wmmaskoutput = "T1wFltmeanAbfcBeWM_binary"
...
"""*****************************"""
erodeinput1 = "T1wFltmeanAbfcBeCSF"
erodeoutput1 = "T1wFltmeanAbfcBeCSF_Erode"

erodeinput2 = "T1wFltmeanAbfcBeGM"
erodeoutput2 = "T1wFltmeanAbfcBeGM_Erode"

erodeinput3 = "T1wFltmeanAbfcBeWM"
erodeoutput3 = "T1wFltmeanAbfcBeWM_Erode"
...
#or not
filecheckerfile = "T1wFltmeanAbfcBeWM_Erode.nii.gz"
...
for k in steps:
    ...
    if k == 'wmmask':
        for i in participants:
            ...
            intermediate = dir_in + person + "_" + "_WhiteMatterT1_rlt.nii.gz"
    ...
    if k == 'erode':
        for i in participants:
            ...
            intermediate1 = dir_in + person + "_" + "_csfthreshT1.nii.gz"
            output_file1 = dir_in + person + "_" + erodeoutput1 + ".nii.gz"
            input_file2 = dir_in + person + "_" + erodeinput2 + ".nii.gz"
            intermediate2 = dir_in + person + "_" + "_gmthreshT1.nii.gz"
            ...
            intermediate3 = dir_in + person + "_" + "_wmthreshT1.nii.gz"
            if os.path.isfile(input_file1) == False:
                x = "This file doesn't exist: " + input_file1
                print(x)
                log.append(x) 
