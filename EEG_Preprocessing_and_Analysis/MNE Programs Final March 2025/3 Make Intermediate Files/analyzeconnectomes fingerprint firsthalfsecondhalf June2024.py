...
This program takes combined EEG connectomes (generated by source localization 8 task june2024_v2)
...
savesumdir = '/Users/ivy/Desktop/Graff_EEG_stuff/precise_KIDS_final/results_august2024/x_fingerprint_timesubset/'
            ...
            if os.path.isfile(logname) == False or replacer == True:
                ...
                for family in families:
                    ...
                    for page in participant_ages:
                        ...
                        filetoload1 = personfolder + 'connectomes_combined_0624/' + parc + '/' + strper + '_combined_' + parc + '_' + conmethod + '_' + str(fmin) + 'Hz-' + str(fmax) + 'Hz_' + str(timesub) + 'e_firsthalf.csv'
                        filetoload2 = personfolder + 'connectomes_combined_0624/' + parc + '/' + strper + '_combined_' + parc + '_' + conmethod + '_' + str(fmin) + 'Hz-' + str(fmax) + 'Hz_' + str(timesub) + 'e_secondhalf.csv'
                        
                        if not os.path.isfile(filetoload1):
                            xxy=3
                            #print("This does not exist " + filetoload1)
                        else:
                            #print("Loading",filetoload1)
