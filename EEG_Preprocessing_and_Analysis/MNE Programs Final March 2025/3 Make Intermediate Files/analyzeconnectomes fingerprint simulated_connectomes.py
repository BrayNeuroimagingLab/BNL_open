...
This program takes simulated EEG connectomes (generated by source localization 8 make sim connectomes)
...
It averages all the randomized simulated connectomes in the relevant recording folder
...
savesumdir = '/Users/ivy/Desktop/Graff_EEG_stuff/precise_KIDS_final/results_august2024/x_fingerprint_onlysim100/'
                        ...
                        for task in tasks:
                            ...
                            if len(prefixed) == 0:
                                ...
                                if len(fullfile) > 1:
                                    ...
                                    filetosaveprefix2 = fullfile[0].split('_')
                                    specifictask = filetosaveprefix2[2].split('-')[1]
                                    ...
                                    if os.path.isfile(test_fwd) and os.path.isfile(test_name):
                                        ...
                                        randfiles = [filename for filename in os.listdir(folderhere) if filename.startswith(saveconnectome_start)]
                                        ...
                                        if len(randfiles) == 0:
                                            ...
                                            for randfile in randfiles:
                                                ...
                                                saveconnectome = folderhere + randfile
                                                
                                                if os.path.isfile(saveconnectome):
                                                    print("Loading " + saveconnectome)
                                            
                                                    parceldata1 = pd.read_csv(saveconnectome,index_col=0)
                                                    rparcellist.append(parceldata1)
                                                
                                                    
                                                
                                            randvecs = []
                                            for i in range(len(rparcellist)):
                                                
                                                scanhere = rparcellist[i]    
                                                
                                                FCm = np.squeeze(np.asarray(scanhere))
                                                FCm = np.arctanh(FCm)
                                            ...
                                            FCallvec.append(np.asarray(newvec2))
