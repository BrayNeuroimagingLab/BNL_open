"""
Structural Preprocessing. This program corrects for inhomogenities, skull strips, registers to a template, tissue segments, and tissue erodes
...
template_dir = '/Users/example/example/mni_icbm152_nlin_asym_09c/'
...
#obviously if the first folder in your directory doesn't contain MRI stuff, then it won't work
...
#atrop = Use ANTs ATROPOS to generate tissue segmentations. ~5 minutes per image or something. I forget
...
abetemplate = template_dir + "mni_icbm152_t1_tal_nlin_asym_09c.nii"
...
armatrixoutputname = "transformT1wtoMNI"
...
arinputfixedimage = template_dir + "mni_icbm152_t1_tal_nlin_asym_09c.nii"
...
atropinput = "T1wAbfcBeAr"
atropCSFoutput = "T1wAbfcBeArCSF"
atropGMoutput = "T1wAbfcBeArGM"
atropWMoutput = "T1wAbfcBeArWM"

#tt0 are the 3 tissue priors of a template
# CSF file = tissue1
# GM file = tissue2
# WM file = tissue3

#the actual file names should be like
#mni_icbm152_tissuet01
#mni_icbm152_tissuet02
#mni_icbm152_tissuet03
#(basically %02d will cycle through 01 02 03)
...
"""*******************************************"""
segwarpinput1 = "T1wAbfcBeArCSF"
segwarpoutput1 = "T1wAbfcBeCSF"

segwarpinput2 = "T1wAbfcBeArGM"
segwarpoutput2 = "T1wAbfcBeGM"

segwarpinput3 = "T1wAbfcBeArWM"
segwarpoutput3 = "T1wAbfcBeWM"

#what matrix file warps the inputs to the outputs?
segwarpmatrix = "transformT1wtoMNIinverse.h5"

#give a reference image for the output files. Presumably the native space image
segwarpreference = "T1wAbfcBe"


"""*************************"""
"""wmmask: fslmaths OPTIONS"""
"""*************************"""
wmmaskinput = "T1wAbfcBeWM"
wmmaskoutput = "T1wAbfcBeWM_binary"
...
"""*****************************"""
erodeinput1 = "T1wAbfcBeCSF"
erodeoutput1 = "T1wAbfcBeCSF_Erode"

erodeinput2 = "T1wAbfcBeGM"
erodeoutput2 = "T1wAbfcBeGM_Erode"

erodeinput3 = "T1wAbfcBeWM"
erodeoutput3 = "T1wAbfcBeWM_Erode"
...
for k in steps:
    ...
    if k == 'atrop':
        for i in participants:
            ...
            for j in imagesession:
                dir_in = dir_start + person + "/" + j + "/anat/"
                input_file = dir_in + person + "_" + j + "_" + atropinput + ".nii.gz"
                output_fileCSF = dir_in + person + "_" + j + "_" + atropCSFoutput + ".nii.gz"
                output_fileGM = dir_in + person + "_" + j + "_" + atropGMoutput + ".nii.gz"
                output_fileWM = dir_in + person + "_" + j + "_" + atropWMoutput + ".nii.gz"
                if os.path.isfile(input_file) == False:
                    x = "This file doesn't exist: " + input_file
                    print(x)
                    log.append(x)
    ...
    if k == 'segwarp':
        for i in participants:
            ...
            for j in imagesession:
                dir_in = dir_start + person + "/" + j + "/anat/"
                input_file1 = dir_in + person + "_" + j + "_" + segwarpinput1 + ".nii.gz"
                output_file1 = dir_in + person + "_" + j + "_" + segwarpoutput1 + ".nii.gz"
                input_file2 = dir_in + person + "_" + j + "_" + segwarpinput2 + ".nii.gz"
                output_file2 = dir_in + person + "_" + j + "_" + segwarpoutput2 + ".nii.gz"
                input_file3 = dir_in + person + "_" + j + "_" + segwarpinput3 + ".nii.gz"
                output_file3 = dir_in + person + "_" + j + "_" + segwarpoutput3 + ".nii.gz"
                if os.path.isfile(input_file1) == False:
                    ...
                    if doit == True:
                        ...
                        try:
                            ...
                            myaat.inputs.reference_image = dir_in + person + "_" + j + "_" + segwarpreference + ".nii.gz"
    ...
    if k == 'wmmask':
        for i in participants:
            ...
            for j in imagesession:
                dir_in = dir_start + person + "/" + j + "/anat/"
                input_file = dir_in + person + "_" + j + "_" + wmmaskinput + ".nii.gz"
                intermediate = dir_in + person + "_" + j + "_WhiteMatter_rlt.nii.gz"
                output_file = dir_in + person + "_" + j + "_" + wmmaskoutput + ".nii.gz"
                if os.path.isfile(input_file) == False:
                    x = "This file doesn't exist: " + input_file
                    print(x)
                    log.append(x)
    ...
    if k == 'erode':
        for i in participants:
            ...
            for j in imagesession:
                dir_in = dir_start + person + "/" + j + "/anat/"
                input_file1 = dir_in + person + "_" + j + "_" + erodeinput1 + ".nii.gz"
                intermediate1 = dir_in + person + "_" + j + "_csfthresh.nii.gz"
                output_file1 = dir_in + person + "_" + j + "_" + erodeoutput1 + ".nii.gz"
                input_file2 = dir_in + person + "_" + j + "_" + erodeinput2 + ".nii.gz"
                intermediate2 = dir_in + person + "_" + j + "_gmthresh.nii.gz"
                output_file2 = dir_in + person + "_" + j + "_" + erodeoutput2 + ".nii.gz"
                input_file3 = dir_in + person + "_" + j + "_" + erodeinput3 + ".nii.gz"
                output_file3 = dir_in + person + "_" + j + "_" + erodeoutput3 + ".nii.gz"
                intermediate3 = dir_in + person + "_" + j + "_wmthresh.nii.gz"
                if os.path.isfile(input_file1) == False:
                    x = "This file doesn't exist: " + input_file1
                    print(x)
                    log.append(x) 
